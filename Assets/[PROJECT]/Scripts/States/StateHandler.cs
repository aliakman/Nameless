...
namespace State
{
    public partial class StateHandler<T> : ReferenceHolder where T : Enum
    {
        ...
        public void ChangeMainState(T _stateKey)
        {
            ...
            if (currentMainState != null)
            {
                ...
                Debug.Log($"MAIN {_stateKey} STATE EXIT  :  {gameObject.name}");
            }
            else
        ...
        public void ChangeSubState(T _stateKey)
        {
            ...
            if (currentSubState != null)
            {
                ...
                Debug.Log($"SUB {_stateKey} STATE EXIT  :  {gameObject.name}");
            }
            else
                formerSubState = null;
